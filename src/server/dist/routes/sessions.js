...
router.post('/create', authenticateUser, fileUpload_1.upload.single('photo'), async (req, res) => {
    try {
        ...
        const photoUrl = (0, fileUpload_1.getFileUrl)(req.file.path);
      ...
      `)
        ...
        const formattedSessions = sessions.map(session => {
            ...
            return {
                ...
                photoUrl: (0, fileUpload_1.getFileUrl)(session.photo_url),
...
async function processSessionAsync(sessionId, photoPath) {
    try {
        ...
        const photoUrl = (0, fileUpload_1.getFileUrl)(photoPath);
